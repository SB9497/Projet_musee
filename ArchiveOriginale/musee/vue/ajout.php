<!--page d'ajout d'oeuvre-->
<div class="container">
    <div class="row">

        <h1><img src="./image/zxj.jpg" style="width: 3rem">Création</h1><br>
        ...
        <div class='col'><br>
            <div class="card bg-black border-dark" style="width: 35rem;">
                <div class="card-body">
                    <h5 class="card-title">Ajouter une Oeuvre</h5><br>
                     <!--affichage d'un formaulaire d'ajout d'un oeuvre-->
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select bg-black text-white" required="required" name="collection" id="collection-select">
                                <option value="" class='text-muted'>Selectionnez une collection</option>
                                  <!--permet de choisir une collection lors de l'ajout-->
        ...
        <!--permet l'ajout d'une nouvelle collection-->
        <div class='col'><br>
            <div class="card bg-black border-dark" style="width: 35rem;">
                <div class="card-body">
